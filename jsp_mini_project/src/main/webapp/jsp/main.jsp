...
<body>
        ...
        <div class="container-fluid">
            <div class="nav">
                ...
                <ul class="nav-menu menu-main">
                    <li><a href="javascript:void(0)" onclick="window.scrollTo({top: 0, behavior: 'smooth'});">home</a></li>
                ...
                <ul class="nav-menu">
                    <li>
                        ...
                        <!-- bx-search 클릭 시 search input bar 표시,
            ...
            <div class="col-4">
                <div class="slide-info-wrapper">
                    ...
                    <div class="slide-info active">
                        ...
                        <div class="slide-description">
                            <p class="top-down delay-4">
                                자연과 피부를 위한 선택, 비건 스킨케어 패키지. 
                                순식물성 성분으로 만든 환경 친화적인 제품으로 건강한 아름다움을 경험하세요.
                            </p>
                        </div>
                    ...
                    <div class="slide-info">
                        ...
                        <div class="slide-description">
                            <p class="top-down delay-4">
                                피부 본연의 빛을 깨우는 페이스 세럼. 
                                집중적인 수분과 영양으로 매일 더 건강하고 빛나는 피부를 선사합니다.
                            </p>
                        </div>
                        <div class="slide-action">
                            <a href="#" class="btn btn-lg top-down delay-6">
                    ...
                    <div class="slide-info">
                        ...
                        <div class="slide-description">
                            <p class="top-down delay-4">
                                눈가의 깊은 영양, 우리의 아이크림. 
                                섬세한 눈가를 위한 자연 유래 성분으로 탄탄한 보습을 선사합니다.
                            </p>
                        </div>
                        <div class="slide-action">
                            <a href="#" class="btn btn-lg top-down delay-6">
            ...
            <div class="col-8 slide-img-col">
                <div class="slide-img-wrapper">
                    <div class="slide-img" id="slide-img">
                        ...
                        <img src="../images/banner/veganBg1.png" alt="">
                        <img src="../images/banner/veganBg2.png" alt="">
                    </div>
                </div>
                    ...
                    <div class="glide__track" data-glide-el="track">
                        <ul class="glide__slides">
                            <li class="glide__slide">
                                <div class="product">
                                    <div class="product-img" data-img-1="../images/products/Tom-Ford-RUBY-RUSH.png"
                                    ...
                                    <a href="#" class="product-info">
                                        ...
                                        <div class="product-price">
                                            <del>27,988원</del> <span class="main-color">23,988원</span>
                                        </div>
                                    </a>
                                </div>
                            </li>
                            <li class="glide__slide">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-price">
                                            <del>14,988원</del> <span class="main-color">11,988원</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="glide__slide">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-price">
                                            <del>30,100원</del> <span class="main-color">27,588원</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="glide__slide">
                                <div class="product">
                                    <div class="product-img" data-img-1="../images/products/son-kem-ysl-425.png"
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-price">
                                            <del>24,388원</del> <span class="main-color">20,388원</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="glide__slide">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-price">
                                            <del>23,588원</del> <span class="main-color">20,588원</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="glide__slide">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-price">
                                            <del>18,788원</del> <span class="main-color">16,788원</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="glide__slide">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-price">
                                            <del>24,788원</del> <span class="main-color">22,788원</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="glide__slide">
                                <div class="product">
                                    ...
                                    <a href="#" class="product-info">
                                        ...
                                        <div class="product-price">
                                            <del>28,388원</del> <span class="main-color">26,388</span>
                                        </div>
                                    </a href="#">
                                </div>
                            </li>
                            <li class="glide__slide">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-price">
                                            <del>30,788원</del> <span class="main-color">28,788원</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
        ...
        <div class="row">
            ...
            <div class="col-6 bg-main">
                <div class="special-product">
                    ...
                    <h2>changing <span class="main-color">the</span> ideal of <span class="main-color">beauty</span>
                    </h2>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur voluptate, fugit deserunt
                        eos eligendi tempora, quaerat, accusantium est quibusdam accusamus ad illo similique tenetur nam
                        quidem reprehenderit culpa explicabo quisquam.</p>
                            ...
                            <li class="glide__slide">
                                <div class="product">
                                    ...
                                    <a href="#" class="product-info">
                                        ...
                                        <div class="product-price">
                                            <del>18,388원</del> <span class="main-color">14,388원</span>
                                        </div>
                                    </a href="#">
                                </div>
                            </li>
                            <li class="glide__slide">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-name">
                                            모든 헤어 타입에 적합한 황산염 무함유
                                        </div>
                                        <div class="product-price">
                                            <del>27,188원</del> <span class="main-color">25,188원</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="glide__slide">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-price">
                                            <del>21,188원</del> <span class="main-color">19,188원</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            <li class="glide__slide">
                                <div class="product">
                                    ...
                                    <div class="product-info">
                                        ...
                                        <div class="product-price">
                                            <del>11,788원</del> <span class="main-color">10,788원</span>
                                        </div>
                                    </div>
                                </div>
                            </li>
    ...
    <div class="section">
        <div class="section-header">
            <a href="#">
                <img src="../images/logos/logo.png"  alt="" class="medium-logo">
            </a>
        </div>
            ...
            <div class="glide__track" data-glide-el="track">
                <ul class="glide__slides">
                    <li class="glide__slide">
                        <a href="#" class="gallery-img">
                            <div class="img-holder"
                                style="background-image: url(../images/banner/andrey-zvyagintsev-XM8OXHhzOsU-unsplash.jpg);">
                            </div>
                            <div class="banner-overlay"></div>
                    ...
                    <li class="glide__slide">
                        <a href="#" class="gallery-img">
                            <div class="img-holder"
                                style="background-image: url(../images/banner/andriyko-podilnyk-F4AMM1293ag-unsplash.jpg);">
                            </div>
                            <div class="banner-overlay"></div>
                            <i class='bx bxl-instagram'></i>
                        </a>
                    ...
                    <li class="glide__slide">
                        <a href="#" class="gallery-img">
                            <div class="img-holder"
                                style="background-image: url(../images/banner/johanne-kristensen-1A5hSvPZjMc-unsplash.jpg);">
                            </div>
                            <div class="banner-overlay"></div>
                            <i class='bx bxl-instagram'></i>
                        </a>
                    ...
                    <li class="glide__slide">
                        <a href="#" class="gallery-img">
                            <div class="img-holder"
                                style="background-image: url(../images/banner/kadian-hall-k7ptCKVdDXE-unsplash.jpg);">
                            </div>
                            <div class="banner-overlay"></div>
                            <i class='bx bxl-instagram'></i>
                        </a>
                    ...
                    <li class="glide__slide">
                        <a href="#" class="gallery-img">
                            <div class="img-holder"
                                style="background-image: url(../images/banner/kadian-hall-QixHMdu4THc-unsplash.jpg);">
                            </div>
                            <div class="banner-overlay"></div>
                            <i class='bx bxl-instagram'></i>
                        </a>
                    ...
                    <li class="glide__slide">
                        <a href="#" class="gallery-img">
                            <div class="img-holder"
                                style="background-image: url(../images/banner/marek-studzinski-mzstXkKH8DI-unsplash.jpg);">
                            </div>
                            <div class="banner-overlay"></div>
                            <i class='bx bxl-instagram'></i>
                        </a>
                ...
                <div class="col-3">
                    <div class="footer-content">
                        ...
                        <p class="text-gray">
                            ...
                            asperiores officiis odit animi, labore laboriosam sunt deserunt dolores molestias
                            accusantium eius fugiat adipisci et repellendus nihil neque.
                        </p>
                        <p>
                            1366 Gyeongwon-daero, Bupyeong-gu, Incheon, Republic of Korea (21404)
                        </p>
                        <p>
                            allyvegan@mail.com
                        </p>
    ...
    <!-- COPYRIGHT -->
    <div class="copyright">
        2024 Ally brand- <a href="https://github.com/Nomiya623/miniProject1.git" target="_blank">Nomiya623</a>
    </div>
    <!-- END COPYRIGHT -->
